...
import com.SmartCanteen.AdminView.AdminMainFrm;
...
public class LogOnFrm extends javax.swing.JFrame {
	...
	public static User s_currentUser = null;//保存登录用户的参数
		...
		try {
			...
			if (currentUser != null) {
				...
				if (userName.equals("admin")) {
					this.dispose();
					new AdminMainFrm().setVisible(true);//进入管理员页面
				} else {
					this.dispose();
					new CustomerMainFrm().setVisible(true);//进入用户点餐界面
				}
			} else {
